                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pname">
                                    ...
                                    <div class="name">
                                        <div class="category-text">{{ $product->category->name ?? 'N/A' }}</div>
                                ...
                                <td>
                                    @if($product->sale_price && $product->sale_price < $product->regular_price)
                                        <span class="text-decoration-line-through">${{ number_format($product->sale_price, 2) }}</span>
                                        <span class="ms-2">${{ number_format($product->regular_price, 2) }}</span>
                                    @else
